...
import User from "../models/User.js"; // Ensure the file exists with the correct extension
...
const addEmployee = async (req, res) => {
  try {
    ...
    console.error("Error adding employee:", error); // Log the full error
...
//       .populate("userId", { password: 0 }) // Populate user details but exclude password
